...
class auth_approved_util_testcase extends advanced_testcase {
    ...
    public function test_render_request_details_view() {
        ...
        $this->assertContains('<dt>First name</dt><dd>test1 firstname</dd>', $report);
        $this->assertContains('<dt>Last name</dt><dd>test1 surname</dd>', $report);
        $this->assertContains('<dt>Username</dt><dd>test1_username</dd>', $report);
        $this->assertContains('<dt>Email address</dt><dd>test1@example.com</dd>', $report);
        ...
        $report = \auth_approved\util::render_request_details_view($requestid);
        $this->assertContains('<dt>First name</dt><dd>test2 firstname</dd>', $report);
        $this->assertContains('<dt>Last name</dt><dd>test2 surname</dd>', $report);
        $this->assertContains('<dt>Username</dt><dd>test2_username</dd>', $report);
        $this->assertContains('<dt>Email address</dt><dd>test2@example.com</dd>', $report);
        $this->assertContains('<dt>Email confirmed</dt><dd>No</dd>', $report);
        $this->assertNotContains('monkey', $report);
