 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class group_requested extends base {
    ...
    public function get_description() {
        return "user with id '$this->objectid' requested access to a group.";
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'user', 'group_requested', '/view.php?id='.$this->objectid, fullname($this->get_legacy_eventdata()));
    }
