...
class core_dml_testcase extends database_driver_testcase {
    ...
    public function test_sql_round() {
        ...
        $this->assertEqualsWithDelta(13, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(12.499, 0) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(12, $DB->get_field_sql($sql), 0.0001);
        ...
        $this->assertEqualsWithDelta(11, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(11.511, 2) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(11.51, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(11.499, 2) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(11.5, $DB->get_field_sql($sql), 0.0001);
        ...
        $this->assertEqualsWithDelta(667, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(666.666, -2) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(700, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(666.666, -3) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(1000, $DB->get_field_sql($sql), 0.0001);
        $sql = "SELECT " . $DB->sql_round(666.666, -4) . " AS res " . $DB->sql_null_from_clause();
        $this->assertEqualsWithDelta(0, $DB->get_field_sql($sql), 0.0001);
    }
