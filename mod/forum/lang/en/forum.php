...
$string['topic'] = 'Topic';
$string['oaklandgroup'] = 'Oakland Group';
$string['bynamebygroupondate'] = 'by {$a->name}, {$a->groupname} - {$a->date}';
$string['searchtopic'] = 'These words should be in the topic';
$string['searchuserwhoposted'] = 'This name should match the user who posted';
$string['oaklandgroupname'] = 'This name should match the group name used for posting';
$string['numberofviews'] = 'Posting that has greater than or equal to this number of views';
$string['resourcetype'] = 'Resource Type';
$string['resourcetypesearch'] = 'This name should match resource type';
