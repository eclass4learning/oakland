...
final class reservations {
     ...
     * @return stdClass containing potential - list of users who could be allocated
     ...
     */
    public static function get_staff_to_allocate(seminar $seminar, seminar_event $seminarevent , int $managerid = null): stdClass {
        global $DB, $USER;
     ...
     *
     * @param stdClass $user A user object that must contain id, bookedby and status code
     * @param int $managerid The user's manager ID.
     * @return bool True if the user can be unallocated, false otherwise.
     */
    public static function user_can_be_unallocated(stdClass &$user, int $managerid): bool {
