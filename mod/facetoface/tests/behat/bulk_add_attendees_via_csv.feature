...
Feature: Add seminar attendees in bulk via csv file
  ...
  Scenario: Upload csv file using 'Comma' delimiter option with email address and no required custom fields
    Given I click on "Attendees" "link"
    And I click on "Add users via file upload" "option" in the "#menuf2f-actions" "css_element"
    And I upload "mod/facetoface/tests/fixtures/f2f_attendees_email_no_customfields.csv" file to "CSV file" filemanager
    And I set the field "delimiter" to "Comma (,)"
    And I press "Continue"
    When I press "Confirm"
  ...
  Scenario: Upload csv file using 'Comma' delimiter option with username and no required custom fields
    Given I click on "Attendees" "link"
    And I click on "Add users via file upload" "option" in the "#menuf2f-actions" "css_element"
    And I upload "mod/facetoface/tests/fixtures/f2f_attendees_username_no_customfields.csv" file to "CSV file" filemanager
    And I set the field "delimiter" to "Comma (,)"
    And I press "Continue"
    When I press "Confirm"
    Then I should see "Booked" in the "John1 Smith1" "table_row"
  ...
  Scenario: Upload csv file using 'Comma' delimiter option with idnumber and no required custom fields
    Given I click on "Attendees" "link"
    And I click on "Add users via file upload" "option" in the "#menuf2f-actions" "css_element"
    And I upload "mod/facetoface/tests/fixtures/f2f_attendees_idnumber_no_customfields.csv" file to "CSV file" filemanager
    And I set the field "delimiter" to "Comma (,)"
    And I press "Continue"
    When I press "Confirm"
    Then I should see "Booked" in the "John1 Smith1" "table_row"
