...
Feature: Allocate spaces for team in seminar
  ...
  Scenario: Manager can deallocate users that he has allocated in the current session
    ...
    Then the "Current allocations" select box should contain "Sam1 Student1\, student1@example.com"
    When I click on "Sam1 Student1" "option"
    And I press "Remove"
    And I click on the link "Allocate spaces for team" in row 1
    Then the "Potential allocations" select box should contain "Sam1 Student1\, student1@example.com"
    And I log out
  ...
  Scenario: Capacity should be unaffected if removing allocation and create reservations when removing allocations is set to Yes
    ...
    And the "Current allocations" select box should not contain "Sam1 Student1\, student1@example.com"
    And the "Potential allocations" select box should contain "Sam1 Student1\, student1@example.com"
    And I log out
  ...
  Scenario: Manager cannot see users allocated from another managers
    ...
    And I follow "View all events"
    And I click on the link "Allocate spaces for team" in row 1
    Then the "Current allocations" select box should not contain "Sam1 Student1\, student1@example.com"
    And I log out
  ...
  Scenario: Manager cannot deallocate self booked users even if he is their manager
    ...
    And I follow "View all events"
    And I click on the link "Allocate spaces for team" in row 1
    Then the "Current allocations" select box should contain "Sam1 Student1\, student1@example.com (Self booked)"
    When I click on "Sam1 Student1" "option"
    And I press "Remove"
    And I click on the link "Allocate spaces for team" in row 1
    Then the "Current allocations" select box should contain "Sam1 Student1\, student1@example.com (Self booked)"
