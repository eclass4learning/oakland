...
if ($form->is_cancelled()) {
    ...
    if ($data->templateid != 0) {
        ...
        $clonedata = file_prepare_standard_editor($clonedata, 'body', $editoroptions, $context, 'mod_facetoface', 'notification', $id);
        $clonedata = file_prepare_standard_editor($clonedata, 'managerprefix', $editoroptions, $context, 'mod_facetoface', 'notification', $id);
