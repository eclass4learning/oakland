...
$string['display_help'] = 'Determines where the package will be displayed. Note: displaying in a new window will load a popup – this could confuse screen reader users, and trigger popup blockers.';
