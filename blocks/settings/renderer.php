...
class block_settings_renderer extends plugin_renderer_base {
    ...
    protected function navigation_node(navigation_node $node, $attrs=array()) {
        ...
        foreach ($items as $item) {
            ...
            /*
             * BEGIN OAKLAND CUSTOMIZATION
             * Added to hide the Admin tree menu as a result of the dashboard editor role granting too many rights to
             * group administrators. See OS-208
             */
            if(false !== stripos($content, 'Site admin') && !is_siteadmin($USER->id)){
                continue;
            }
            /*
             *  END OAKLAND CUSTOMIZATION
             */
