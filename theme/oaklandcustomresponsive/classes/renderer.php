...
class theme_oaklandcustomresponsive_renderer extends theme_roots_renderer {
    ...
    public function page_footer_nav($menudata) {
        $renderable = new theme_oaklandcustomresponsive\output\page_footer_nav($menudata);
    ...
    protected function render_page_footer_nav($renderable) {
        ...
        return $this->render_from_template('theme_oaklandcustomresponsive/page_footer_nav', $templatecontext);
    }
