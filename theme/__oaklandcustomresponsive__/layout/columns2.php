...
<header role="banner" class="navbar">
    <nav role="navigation" class="navbar-inner">
        <div id="navbar-inside" class="container-fluid">
            <?php if ($logourl == NULL) { ?>
                <div id="logo" class="img-responsive"><a href="<?php echo $CFG->wwwroot. '/totara/dashboard/index.php?id=356'; ?>">&nbsp;</a></div>
            <?php } else { ?>
                <div id="logo" class="custom img-responsive">
                    <a href="<?php echo $CFG->wwwroot. '/totara/dashboard/index.php?id=356'; ?>">
