 ...
 */
class theme_oaklandcustomresponsive_core_renderer extends core_renderer {
  ...
  //  protected function render_tabtree(tabtree $tabtree) {
   ...
   //     }
    ...
    protected function render_custom_menu_item(custom_menu_item $menunode) {
        ...
        $content = html_writer::start_tag('li'); //TODO: I actually do not need this anymore.
...
class theme_oaklandcustomresponsive_core_course_renderer extends core_course_renderer {
    /**
