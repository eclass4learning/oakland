...
function xmldb_totara_core_upgrade($oldversion) {
    ...
    if ($oldversion < 2018112335) {
        ...
        // Main savepoint reached.
        upgrade_plugin_savepoint(true, 2018112335, 'totara', 'core');
    }

    if ($oldversion < 2018112344) {
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2018112344, 'totara', 'core');
    }
