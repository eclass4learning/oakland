...
function xmldb_totara_dashboard_upgrade($oldversion) {
  ...
  if ($oldversion < 2015042800) {
        ...
        $field = new xmldb_field('allowguest',XMLDB_TYPE_INTEGER,2,null,true,null,0);
        ...
        totara_upgrade_mod_savepoint(true, 2015042800, 'totara_dashboard');
    }
    if ($oldversion < 2015050700) {
        $table = new xmldb_table('totara_dashboard');
        $field = new xmldb_field('oaklandgroupid',XMLDB_TYPE_INTEGER,10,null,null,null,null);
        ...
        // Main savepoint reached.
        totara_upgrade_mod_savepoint(true, 2015050700, 'totara_dashboard');
    }
