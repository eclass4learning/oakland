...
class rb_source_program_overview extends rb_base_source {
    ...
    protected function define_columnoptions() {
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition('course.shortname', 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'shortname',
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('course_completions.status'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'status',
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('course_completions.timeenrolled'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'timeenrolled',
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('course_completions.timestarted'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'timestarted',
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('course_completions.timecompleted'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'timecompleted',
        ...
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('grade_grades.finalgrade'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'finalgrade',
        ...
        $from = "FROM {prog_courseset} prog_courseset
            ...
            LEFT JOIN {course_completion_criteria} criteria ON criteria.course = prog_courseset_course.courseid AND criteria.criteriatype = " . COMPLETION_CRITERIA_TYPE_GRADE . "
                WHERE prog_courseset.programid = base.programid";
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition($DB->sql_cast_2char('criteria.gradepass'), 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'gradepass',
        ...
        $from = "FROM {prog_courseset} prog_courseset
            ...
            LEFT JOIN {course_categories} course_category ON course_category.id = course.category
                WHERE prog_courseset.programid = base.programid";
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition('course_category.name', 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'name',
        ...
        $concat = $DB->sql_group_concat(
            ...
            $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'namelink',
        ...
        $from = "FROM {prog_courseset} prog_courseset
            ...
            LEFT JOIN {course_categories} course_category ON course_category.id = course.category
                WHERE prog_courseset.programid = base.programid";
        $concat = $DB->sql_group_concat(\totara_program\rb_course_sortorder_helper::get_column_field_definition('course_category.idnumber', 'prog_courseset.programid'), $this->uniquedelimiter, 'prog_courseset.sortorder ASC, prog_courseset_course.id');
        $columnoptions[] = new rb_column_option(
            'course',
            'id',
