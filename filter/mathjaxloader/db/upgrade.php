...
function xmldb_filter_mathjaxloader_upgrade($oldversion) {
    ...
    if ($oldversion < 2017051501.01) {
        // Update CDN url.
        $originalurl = 'https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js';
        ...
        upgrade_plugin_savepoint(true, 2017051501.01, 'filter', 'mathjaxloader');
    }
